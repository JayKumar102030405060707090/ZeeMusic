...
WARNING_CHAT_ID = -1002697050263  # Chat ID for cookie expiry warning
...
# ✅ Automatically check cookies when the bot starts
@app.on_message(filters.command("start") & ~BANNED_USERS)
async def auto_check_cookies(client: Client, message: Message):
